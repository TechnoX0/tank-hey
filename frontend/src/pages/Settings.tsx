    ...
    return (
        <div className="relative text-white font-medium">
            ...
            <div className="flex flex-col gap-8 justify-center align-center">
                <div className="flex flex-row pr-[5dvh] py-[5dvh] mx-[20dvh] mt-[15dvh] gap-5 rounded-lg justify-start bg-[#4d784e]">
                    <div className="flex flex-col justify-start min-w-max gap-5 pr-[3dvh]">
                        <div className="flex">
                            <img
